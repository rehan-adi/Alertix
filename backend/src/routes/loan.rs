...
use crate::{config::db::DbPool, models::event::Event, schema::events, types::types::LoanData};
...
#[post("/loan")]
pub async fn loan(pool: web::Data<DbPool>, data: web::Json<LoanData>) -> impl Responder {
